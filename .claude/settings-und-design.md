...
| 24.08.2026 | NotebookLM-Knopf pusht nicht mehr an den OKF-Server (dessen Endpunkt ignorierte den Body und exportierte alle Serverprojekte), sondern lädt immer nur die Datei herunter; Texte `nbPush`/`nbHandover` entfernt |
